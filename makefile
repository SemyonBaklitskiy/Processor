...
bin/compiler_functions.o: Compiler/src/compiler_functions.cpp Compiler/includes/compiler_functions.h Common/includes/common_functions.h
	g++ -Wall -Wextra -ICommon/includes/ -ICompiler/includes/ -c Compiler/src/compiler_functions.cpp -o bin/compiler_functions.o

bin/compiler_main.o: Compiler/src/main.cpp Compiler/includes/compiler_functions.h
...
bin/cpu_functions.o: CPU/src/cpu_functions.cpp CPU/includes/cpu_functions.h Common/includes/common_functions.h
	g++ -Wall -Wextra -IStack/includes/ -ICPU/includes/ -ICommon/includes/ -c CPU/src/cpu_functions.cpp -o bin/cpu_functions.o

bin/cpu_main.o: CPU/src/main.cpp CPU/includes/cpu_functions.h
